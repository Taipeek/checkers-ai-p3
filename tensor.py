...
model.add(Conv2D(10, (3, 3), input_shape=(8, 8, 6), padding='same', activation='relu'))
model.add(Conv2D(10, (3, 3), padding='same', activation='relu', kernel_regularizer=regularizers.l2(0.00001)))
model.add(Conv2D(10, (3, 3), padding='same', activation='relu', kernel_regularizer=regularizers.l2(0.00001)))
model.add(Conv2D(10, (3, 3), padding='same', activation='relu', kernel_regularizer=regularizers.l2(0.00001)))
